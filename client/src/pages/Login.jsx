...
const Login = ()=>
{
   ...
   return (  
    <div style={{
        backgroundImage:"linear-gradient(rgba(200,200,200,0.5),rgba(120,110,220,0.5))", height: "100vh",
        }}>
         ...
         onSubmit={handleLogin}>
            ...
            onSubmit={handleSignUp}>
                ...
                <Stack position={"relative"} width={"10rem"} margin={"auto"}>
                    ...
                    src={avatar.preview}/>
                    {avatar.error&&(
                        <Typography margin={"1rem"} color = "error" variant="caption"></Typography>
                    )}
                    <IconButton
                    sx={{
                        position:"absolute",
                ...
                {avatar.error&&(
                        <Typography margin={"1rem auto"} 
                        width={"fit-content"}
                        display={"block"}
                        color = "error" variant="caption"></Typography>
                    )}
                     <TextField required fullWidth
               label="Name"
               margin="normal"
